...
- [[slice-81-android-counter]]: counter on Android emulator. blocked_by: [[slice-76-desktop-vsync-window]] and [[slice-70-counter-on-dom]]. met
- [[slice-82-store-binaries]]: packaged binary, not OTA JS. blocked_by: [[slice-80-ios-counter]] and [[slice-81-android-counter]]. met
- [[slice-83-talk-and-measure]]: semantics tree plus text metrics. blocked_by: [[slice-80-ios-counter]]. met
- [[slice-84-platform-view-hatch]]: mobile view in the hatch slot. blocked_by: [[slice-79-oem-hatch-slot]] and [[slice-80-ios-counter]]. met
- [[slice-300-desktop-first]]: mobile follows desktop honesty. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-320-funding]]: mobile is pursued only if native UI is funded. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-328-phase-3-gate-unstated]]: Phase 3 work stays behind desktop honesty. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-356-not-toolchain-d04]]: these triples are this product's mobile packaging, not toolchain D04. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-360-android-not-toolchain-d04]]: these triples are this product's mobile packaging, not toolchain D04. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-364-pipeline-copy]]: a semantics tree is copied as architecture beside the render tree, with a gesture arena and vsync tickers. blocked_by: [[slice-76-desktop-vsync-window]]. met
- [[slice-373-engine-glyphs]]: native glyphs live in the Rust engine. blocked_by: [[slice-76-desktop-vsync-window]]. active

...
Location: [[location-18-native-engine-desktop]]. Phase 2 demos. Native UI funded in [[rounds-160-fund-native]]. Freeze desktop vsync and draw a rect. Do not freeze press or OEM until those APIs are named.
...
- [[slice-78-press-wins-arena]]: gesture arena. blocked_by: [[slice-77-draw-a-rect]]. shaping

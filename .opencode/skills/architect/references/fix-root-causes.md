...
**Incorrect:** Add a nil-check to silence the crash, or skip the repro because there is no simulator.
**Correct:** Reproduce first. Ask why until you hit the cause. Fix that. Grep for the same pattern.

...
**Incorrect:** Implement the first viable approach when there is no precedent.
**Correct:** Build 2-3 competing prototypes. Compare. Then commit. A second flavor of the first shape does not count.

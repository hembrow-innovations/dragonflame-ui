...
**Incorrect:** Two actors write the same file, then take turns by convention.
**Correct:** Give each actor its own file or key. Lock only when one writer is a real invariant.

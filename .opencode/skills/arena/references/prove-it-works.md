...
**Incorrect:** It typechecks, the delegate said it looks good, or the screenshot is cached.
**Correct:** Run the real surface. Read the actual value. Inspect the diff, not the summary.

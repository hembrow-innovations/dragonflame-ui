...
- **tests/absence/no-jsx-here.test.mjs**: `this checkout does not add JSX to the draconic parser`
  - **How:** fails if this checkout adds JSX to the draconic parser
  - **Why:** promise `absence.jsx:no-jsx-here`
- **tests/absence/no-lowerer-here.test.mjs**: `this repo does not fake a general LLVM lowerer`

...
- node --test tests/leaf-view-text-style.test.mjs
- node --test tests/leaf-image-scroll.test.mjs
- node --test tests/leaf-input-pressable.test.mjs

## Tests

- **tests/leaf-view-text-style.test.mjs**: `view and text with style data on CSS`
...
- **tests/leaf-image-scroll.test.mjs**: `image and scroll`
  - **How:** image and scroll leaves render on DOM
  - **Why:** promise `leaf-kit.set:closed`
- **tests/leaf-input-pressable.test.mjs**: `text input and pressable`

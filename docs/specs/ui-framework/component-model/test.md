...
- node --test tests/no-class-components.test.mjs
- node --test tests/no-fiber-vdom.test.mjs
- node --test tests/no-forked-tree.test.mjs

## Tests

- **tests/no-class-components.test.mjs**: `this checkout does not add class components for UI`
...
- **tests/no-fiber-vdom.test.mjs**: `this checkout does not add Fiber as a component identity or a virtual DOM`
...
- **tests/no-forked-tree.test.mjs**: `this checkout does not add a second authoring tree`
